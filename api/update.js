...
module.exports = async (req, res) => {
  ...
  try {
    ...
    // Сортуємо за score, беремо топ-3
    // ✅ Фільтруємо дублікати перед відправкою
    ...
    if (top3.length === 0) {
      // ✅ Не спамимо — звіт тільки раз на годину
      await sendMarketReport(bot, allSignals.length, symbols.length);
    } else {
