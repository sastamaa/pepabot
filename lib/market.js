...
const BLOCKLIST = [
  ...
  'USDG-USDT', 'USDT-USDT', 'OUSD-USDT', 'GUSD-USDT',
  // ✅ Монети яких немає на Bybit
  'PI-USDT',   // Pi Network — немає на Bybit
  'OKB-USDT',  // OKX token — немає на Bybit
  'KAT-USDT',  // мікромонета — немає на Bybit
  'IP-USDT',   // немає на Bybit
];
